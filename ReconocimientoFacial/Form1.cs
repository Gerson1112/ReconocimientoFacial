...
namespace ReconocimientoFacial
{
    public partial class Form1 : Form
    {
                ...
                if (faces.Length > 0)
                {
                    foreach (var face in faces)
                    {
                        ...
                        if (isTrained)
                        {
                            ...
                            {
                                CvInvoke.PutText(CurrentFrame, "Gerson", new Point(face.X - 2, face.Y - 2), FontFace.HersheyComplex, 1.0, new Bgr(Color.Green).MCvScalar);
                            }
        ...
        private void Capturas_Enter(object sender, EventArgs e)
        {
